        ...
        <div id="Prenda">
                        ...
                        foreach($gorro as $key => $value ){
                            ...
                            echo "
                                ...
                                <div class='col-1'>
                                    <div class='poster'>
                                        <a href=''>
                                            <img src='../src/assets/".$gorro[$key]["Img"]."' alt=''  title='".$gorro[$key]["Gorro"]."' />
                                        </a>
                                    </div>
                                </div>
                                <div class='col-2'>
                                        ...
                                        <ul class='Info-Prenda'>
                                            <li>Gorro : ".$gorro[$key]["Gorro"]."</li>
                                            <li>Color : ".$gorro[$key]["Color"]."</li>
                                            <li>Descripcion : ".$gorro[$key]["Descripcion"]."</li>
                                            <li>Precio : ".$gorro[$key]["Precio"]."</li>
                                        </ul>
                                </div>
                                ";
                        }
            ...
            <ul class="MenuDeskopt">
                ...
                <li>
                    ...
                    <a href="../Camisas/index.php">Camisas</a>
                </li>
                <li>
                    <img src="../src/assets/vaqueros.png"/>
                    <a href="../Pantalons/index.php">Pantalones</a>
                </li>
                <li>
                    <img src="../src/assets/gorra.png"/>
                    <a href="index.php">Gorros</a>
                </li>
            </ul>
        </div>
        </div>
