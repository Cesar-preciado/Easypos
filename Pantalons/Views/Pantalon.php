                        ...
                        foreach($pantalon as $key => $value ){
                            ...
                            echo "
                                ...
                                <div class='col-1'>
                                    <div class='poster'>
                                        <a href=''>
                                            <img src='../src/assets/".$pantalon[$key]["Img"]."' alt=''  title='".$pantalon[$key]["Pantalon"]."' />
                                        </a>
                                    </div>
                                </div>
                                <div class='col-2'>
                                        ...
                                        <ul class='Info-Prenda'>
                                            <li>Pantalon : ".$pantalon[$key]["Pantalon"]."</li>
                                            <li>Color : ".$pantalon[$key]["Color"]."</li>
                                            <li>Descripcion : ".$pantalon[$key]["Descripcion"]."</li>
                                            <li>Precio : ".$pantalon[$key]["Precio"]."</li>
                                        </ul>
                                </div>
                                ";
                        }
